...
- observed: `{'corpus_examples': 100000, 'jsonl_rows': 100000, 'stream_mix': {'collatz_structural': 65000, 'general_formal_proof': 16000, 'verifier_replay': 19000}, 'model_kind': 'shared Transformer proof model', 'model_status': 'TRAINED_SHARED_PROOF_TRANSFORMER_SMOKE', 'top_actions': ['TRY_MIXED_MODULUS_DEBT_VERIFIER', 'VERIFY_MIXED_MODULUS_DEBT_TRANSITION', 'REPAIR_MIXED_MODULUS_DEBT_RANK', 'PROPOSE_MIXED_MODULUS_STATE', 'PROPOSE_PROOF_DSL', 'SELF_CORRECT_PROOF_DSL'], 'accepted_claim_count': 1, 'total_claim_count': 4, 'proof_confidence_percent': 0.0}`
...
Train the full RUN-009 proof Transformer on the scaled corpus until it meets the parameter-count and training-step gates, then rerun this preflight.
